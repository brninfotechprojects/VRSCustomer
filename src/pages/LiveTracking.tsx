        ...
        <div className="h-96 bg-gradient-to-br from-blue-100 to-green-100 relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-lg font-semibold text-gray-800">Live Map View</p>
              <p className="text-gray-600">Driver location updates in real-time</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="border-t pt-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xl font-bold text-purple-600">{currentRide.fare}</span>
              </div>
            </div>
          </div>
        </div>
